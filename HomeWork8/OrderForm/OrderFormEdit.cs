...
namespace OrderForm {
  public partial class OrderFormEdit : Form {
    ...
    public OrderFormEdit(Order order, bool editMode = false) : this() {
    ...
    private void btnAddItem_Click(object sender, EventArgs e) {
      OrderItemForm formItemEdit = new OrderItemForm(new OrderItem());
      try {
    ...
    private void EditItem() {
      ...
      OrderItemForm formItemEdit = new OrderItemForm(orderItem);
      if (formItemEdit.ShowDialog() == DialogResult.OK) {
        itemsBindingSource.ResetBindings(false);
      }
    }
